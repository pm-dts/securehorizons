...
import { realEstateServicesData } from "@/../data/real-estate-advisory/real-estate-services";
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <span className="text-xs font-bold uppercase tracking-[0.22em] text-blue-600">
            {realEstateServicesData.badge}
          </span>

          <h2 className="mt-5 text-4xl font-bold tracking-tight text-slate-900 lg:text-5xl">
            {realEstateServicesData.title.first}{" "}
            <span className="text-blue-600">
              {realEstateServicesData.title.highlight}
            </span>
          </h2>

          <p className="mt-6 text-lg leading-8 text-slate-600">
            {realEstateServicesData.description}
          </p>
        </div>

        {/* Services */}
        <div className="mt-16 grid gap-8 md:grid-cols-2 xl:grid-cols-3">
          {realEstateServicesData.services.map((service) => {
