import { PrivacyPolicyHeroData } from "@/../data/privacy-policy/hero"

export default function Hero() {
  const Icon = PrivacyPolicyHeroData.badge.icon;
      ...
      <div className="relative max-w-[1600px] mx-auto px-6 md:px-10 xl:px-16 py-28 lg:py-36">
        <div className="max-w-4xl">
          ...
          <div className="mt-4 grid gap-4">
            {PrivacyPolicyHeroData.stats.map((item) => (
              <div
                key={item.label}
                // className="rounded-xl border border-slate-700 bg-white/5 px-6 py-4 backdrop-blur"
              >
