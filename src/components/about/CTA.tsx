...
import { ctaData } from "@/../data/about/cta";

export default function CTA() {
  return (
    <section className="bg-slate-50 py-24">
      <div className="mx-auto max-w-[1600px] px-6 md:px-10 xl:px-16">
        <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0B5FFF] via-[#2563EB] to-[#1D4ED8] px-8 py-16 shadow-2xl lg:px-16 lg:py-20">
            ...
            <div className="mt-16 grid gap-8 border-t border-white/20 pt-10 sm:grid-cols-3">
              {ctaData.stats.map((stat) => (
                <div key={stat.label}>
                  ...
                  <p className="mt-2 text-sm uppercase tracking-wide text-blue-100">
                    {stat.label}
                  </p>
                </div>
              ))}
