...
import { capitalSolutionsData } from "@/../data/capital-markets/capital-solutions";
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-3xl text-center">
          <span className="text-xs font-bold uppercase tracking-[0.22em] text-blue-600">
            {capitalSolutionsData.badge}
          </span>

          <h2 className="mt-5 text-4xl font-bold tracking-tight text-slate-900 lg:text-5xl">
            {capitalSolutionsData.title.first}{" "}
            <span className="text-blue-600">
              {capitalSolutionsData.title.highlight}
            </span>
          </h2>

          <p className="mt-6 text-lg leading-8 text-slate-600">
            {capitalSolutionsData.description}
          </p>
        </div>

        {/* Solutions */}
        <div className="mt-16 grid gap-8 md:grid-cols-2 xl:grid-cols-5">
          {capitalSolutionsData.solutions.map((solution) => {
